...
Computer Engineer and DevOps enthusiast, have been working with complex systems for nearly 10 years. During this decade, helped at different areas of expertise, like database administration, automation, lifecycle of applications, Linux Administration, IaaC, Kubernetes, CI/CD, cloud administration, etc. Actually, I have a SRE role \href{https://github.com/ZupIT}{@ZupIT} in a SRE team that keeps the platform (from the begginning with the definition of architecture to new features, to workloads and databases running in high availability production environment) for about ten development teams deliver their software to an huge brazilian bank.
